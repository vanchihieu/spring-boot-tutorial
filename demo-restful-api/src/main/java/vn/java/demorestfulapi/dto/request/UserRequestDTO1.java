...
@Getter
@Setter
public class UserRequestDTO1 implements Serializable {
...
//    @Pattern(regexp = "^\\d{9,10}$", message = "Phone is invalid")
    ...
    public UserRequestDTO1() {
    }

    public UserRequestDTO1(String firstName, String lastName, String email, String phone) {
