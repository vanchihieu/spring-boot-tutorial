...
import vn.java.demorestfulapi.model.Address;
import vn.java.demorestfulapi.model.User;
import vn.java.demorestfulapi.repository.criteria.SearchCriteria;
import vn.java.demorestfulapi.repository.criteria.UserSearchQueryCriteriaConsumer;
import vn.java.demorestfulapi.repository.specification.SpecSearchCriteria;
...
import static vn.java.demorestfulapi.util.AppConst.*;

@Component
@Slf4j
public class SearchRepository {
    /**
     * String: Bất biến, không an toàn luồng, sử dụng khi ít thay đổi chuỗi.
     * StringBuilder: Mutable, không an toàn luồng, sử dụng khi có nhiều thay đổi chuỗi trong môi trường đơn luồng.
     * StringBuffer: Mutable, an toàn luồng, sử dụng khi có nhiều thay đổi chuỗi trong môi trường đa luồng.
     */
    @PersistenceContext
